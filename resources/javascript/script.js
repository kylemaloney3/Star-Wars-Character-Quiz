...
const storedCorrectCount = parseInt(storedData.split('=')[1]) || 0;
const storedInorrectCount = parseInt(storedData.split('=')[1]) || 0;
const storedTotalQuestions = parseInt(storedData.split('=')[1]) || 0;
...
submitButton.addEventListener('click', () => {
    ...
    totalQuestions++;
    window.name === totalQuestions;
    submitted = true;
    console.log(`Correct answers: ${storedCorrectCount}/${storedTotalQuestions}`);
    console.log(`Incorrect answers: ${storedCorrectCount}/${storedTotalQuestions}`);
    console.log(`Total questions answered: ${storedTotalQuestions}`);
